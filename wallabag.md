...
[Wallabag](https://github.com/wallabag/wallabag) — это веб-приложение для сохранения статей и чтения их в удобном формате без рекламы, извлекает содержимое веб-страницы, чтобы вы не отвлекались на всплывающие окна.
...
3. После запуска проекта, необходимо подождать 3-5 минут, пока создается база данных, ориентируйтесь на звук работы жестких дисков или установите [Glances](https://github.com/avenom/synology-docker-compose/blob/main/glances.md) для мониторинга работы контейнеров. После создания базы данных, статус контейнеров будет зеленым, но статус контейнера wallabag-db возможно будет оранжевым, не обращайте на это внимание, все должно работать без проблем.
