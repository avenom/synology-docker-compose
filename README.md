...
Кроссплатформенный мониторинг системы с открытым исходным кодом. Позволяет в режиме реального времени отслеживать различные аспекты работы системы, такие как использование процессора, памяти, дисков, сети и т. д. Он также позволяет отслеживать запущенные процессы, вошедших в систему пользователей, температуру, напряжение, скорость вращения вентиляторов, мониторинг контейнеров Docker.

<img src="https://raw.githubusercontent.com/avenom/synology-docker-compose/main/images/glances.png?token=GHSAT0AAAAAACKZL7BXDT3EVC7SSSIGEJIKZLF7GDA">
